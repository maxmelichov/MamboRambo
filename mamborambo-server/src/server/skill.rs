...
You are using MamboRambo, a local Qwen3-TTS HTTP API.
...
4. Call POST /v1/models/load with an empty JSON object. MamboRambo Desktop passes the selected default model paths to mamborambo-server.
